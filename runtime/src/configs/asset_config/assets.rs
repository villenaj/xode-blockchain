...
use crate::{
	UNIT, AccountId, AssetConversion, Assets, Balance, Balances, MILLI_UNIT,
	PoolAssets, Runtime, RuntimeEvent, RuntimeOrigin,
};
use frame_support::{
...
impl pallet_assets::Config<MainAssetsInstance> for Runtime {
	...
	type MetadataDepositPerByte = ConstU128<{ 10 * MILLI_UNIT }>;
	type ApprovalDeposit = ConstU128<{ 10 * MILLI_UNIT }>;
...
impl pallet_asset_conversion_tx_payment::Config for Runtime {
	...
	type OnChargeAssetTransaction = pallet_asset_conversion_tx_payment::SwapAssetAdapter<
		...
		NativeAndAssets,
		AssetConversion,
		ResolveAssetTo<XodeTreasuryAccount, NativeAndAssets>,
	>;
	type WeightInfo = ();
	#[cfg(feature = "runtime-benchmarks")]
